...
<nav class="navbar navbar-expand-lg navbar-dark bg-white">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <div>
            <a href="guideStudent.php?lang=sk">SK</a> | <a href="guideStudent.php?lang=en">EN</a>
        </div>
        ...
        <div class="col-lg-9 col-md-10 col-sm-12">
            ...
            <div class="container">
                  ...
                  <ol>
                    ...
                    <li><?php echo $lang['student2']; ?></li>
                    <li><?php echo $lang['student3']; ?></li>
                    <li><?php echo $lang['student4']; ?></li>
